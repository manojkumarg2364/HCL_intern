                        ...
                        <div className="flex items-center justify-between">
                            <Link className="flex-none text-xl font-semibold dark:text-white" to="/">
                                <div className="flex items-center">
                                    ...
                                    alt="FoodWaves Logo" /><p className="red-text block py-2 pr-4 pl-3  text-base uppercase font-robotocondensed font-bold text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Foodie Man</p>
